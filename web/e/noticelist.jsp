		...
		<div style="min-height:600px;" class="simple-grid-list">
		   ...
		   <ul>
		      <c:forEach items="${listNotice}"  var="temnotice">
			      <li>
					<a  href="${pageContext.request.contextPath}/e/noticeinfo.jsp?id=${temnotice.id}">${temnotice.title}<span class="date"><fmt:formatDate value="${temnotice.pubtime }" pattern="yyyy-MM-dd hh:mm:ss"/></span></a>
				   </li>
			   </c:forEach>
		   </ul>
