        ...
        <form id="xiadanForm" method="post" action="${pageContext.request.contextPath}/admin/dingdanmanager.do" name="xiadanform">
            ...
            <div class="address-list clearfix">
                <div class="plus-address">
                    <span data-toggle="modal" data-target="#newAddressDlg" class="dw-btn"><i class="fa fa-plus"></i>新增地址</span>
                </div>
            ...
            <table class="grid" width="100%"   cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td colspan="2" height="34px">
                        ...
                        <button id="btnXiadan"  class="dw-btn"><i class="fa fa-plus"></i>下单结算</button>

                        <a class="dw-btn" href="${pageContext.request.contextPath}/e/index.jsp">继续选物品</a>
